...
class DTUCAMERA:
    ...
    def __init__(self, CamDevice=4):
        ...
        self.video = cv2.VideoCapture(CamDevice)
        self.video.get(3)
        self.video.get(4)
    ...
    def TakePictures(self, num_frames):
        time.sleep(1)
        # if(autofocus==1):
    ...
    def LiveFeedback(self):
        while (self.video.isOpened()):
            ...
            cv2.putText(img, '+x', (1800, 500), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 2,
                        cv2.LINE_AA)  # OPTIONAL
            cv2.putText(img, '-y', (850, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 2, cv2.LINE_AA)  # OPTIONAL
            cv2.putText(img, '+y', (850, 1020), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 2,
                        cv2.LINE_AA)  # OPTIONAL
            # ------ END OF OVERLAY ------
    ...
    def CameraIntrinsics(self):  # D435 camera
        self.fx = 616.381
        self.fy = 616.494
        self.cx = 327.448
        self.cy = 243.412
